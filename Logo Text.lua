...
local jsonFile = getGameDirectory().."\\moonloader\\resource\\LogoText.json"
...
function main()
    ...
    loadJson()
    ----------------------------------------------------------------
    sampRegisterChatCommand('logotextpos', function()
        changePos = true
        chatmsg("Click the right mouse button to save the position")
    end)
    sampRegisterChatCommand('logotext', function(param)
    ...
    sampRegisterChatCommand('logotextsize', function()
        changeSize = true
    ...
    sampRegisterChatCommand('logotextreset', function() 
        settings = {
            pos = {},
            intLogo = 1,
            size = {}
