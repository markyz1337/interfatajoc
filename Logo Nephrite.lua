...
local jsonFile = getGameDirectory().."\\moonloader\\resource\\ChangeLogo.json"
...
function main()
    ...
    loadJson()
    ----------------------------------------------------------------
    sampRegisterChatCommand('logopos', function()
        changePos = true
    ...
    sampRegisterChatCommand('logosize', function()
        changeSize = true
    ...
    sampRegisterChatCommand('logoreset', function() 
        settings = {
            pos = {},
            intLogo = 1,
            size = {}
