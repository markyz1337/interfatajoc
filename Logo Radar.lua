...
local tdIDs = {9999} -- add 47, 48 ,49 etc
...
local jsonFile = getGameDirectory().."\\moonloader\\resource\\LogoRadar.json"
...
function main()
    ...
    loadJson()
    ----------------------------------------------------------------
    sampRegisterChatCommand('logoradarpos', function()
        changePos = true
        chatmsg("Click the right mouse button to save the position")
    end)
    sampRegisterChatCommand('logoradar', function(param)
    ...
    sampRegisterChatCommand('logoradarsize', function()
        changeSize = true
    ...
    sampRegisterChatCommand('logoradarreset', function() 
        settings = {
            pos = {},
            intLogo = 1,
            size = {}
